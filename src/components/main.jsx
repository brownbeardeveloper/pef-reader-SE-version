...
export default function Main() {
  ...
  return (
    <main className="flex flex-col justify-start items-center h-screen pt-10 pl-20 pr-20 max-w-screen-lg mx-auto">
      ...
      {!viewMode ?
        <UploadFile setReadmode={setViewMode} pefObject={pefObject} setPefObject={setPefObject} fileName={fileName} setFileName={setFileName} howToRead={howToRead} setHowToRead={setHowToRead} />
        :
        <ReadMode setReadmode={setViewMode} pefObject={pefObject} howToRead={howToRead} setHowToRead={setHowToRead} />
      }
